...
public class RealmContentResponse implements Parcelable
{
    ...
    public final static Creator<RealmContentResponse> CREATOR = new Creator<RealmContentResponse>() {


        @SuppressWarnings({
                "unchecked"
        })
        public RealmContentResponse createFromParcel(Parcel in) {
            return new RealmContentResponse(in);
        }

        public RealmContentResponse[] newArray(int size) {
            return (new RealmContentResponse[size]);
        }
